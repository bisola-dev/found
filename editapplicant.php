...
if (isset($_POST['submit'])){
  ...
  // echo $fonn.''.$fullnn.''.$progn.''.$coursen.''.$emaln.''.$candid2;
...
$querxy = mysqli_query($conn, "UPDATE  applicants SET fulln='$fullnn', fon='$fonn',course='$coursen',prog='$progn' WHERE id =$candid2");
...
$queryy = mysqli_query($conn, "SELECT * FROM applicants WHERE id = $candid2 ");
...
<head>
      ...
      <title>EDIT APPLICANTS DETAILS ADMIN.
      </title>
   ...
   <!--preloader-->
      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1> Edit Applicants    :: <div class= "redtext" ><?php if (!empty($ms)){echo $ms;}?></div></h1>
                  <small>Edit applicants details</small>
               </div>
            </section>
            <!-- Main content -->
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           <div class="btn-group" id="buttonlist"> 
                              <a class="btn btn-add " href="applicant.php"> 
                              <i class="fa fa-list"></i>  Applicants list </a>  
                           </div>
                        </div>
        ...
        <input type="text" value="<?php echo $fulln; ?>" id="username" class="form-control" name="fullnn">
                                  
                                </div>

                                <div class="form-group ">
                                    <label>Email</label>
                <input type="text" value="<?php echo $emal; ?>" id="username" class="form-control" name="emaln" disabled>
                                 ...
                                 <div class="form-group ">
                                  <input type="hidden" name="candid12"  value="<?php echo $candid2;?>">
                                    <label>phone</label>
                      <input type="text" value="<?php echo $fon; ?>" id="username" class="form-control" name="fonn">
  ...
  ?>
                                ...
                                <div class="form-group">
                                 ...
                                 <select class="form-control" name="progn">
                                    <option value="<?php echo $prog; ?>"><?php echo $prog;?></option>
                                    <option value="ND full time">ND full time</option>
                                    <option value="ND Part time">ND parttime</option>
                                    <option value="HND Full time">HND fulltime</option>
                                    <option value="HND Part time">HND parttime</option>
                              ...
                              <div class="reset-button">
                                 ...
                                 <button type="submit" name ="updater" class="btn btn-success">UPDATE RECORD</button>
                              </div>
                           </form>
                        </div>
                     </div>

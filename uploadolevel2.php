...
$counter = 1;                     
 while ($counter < 10) {
  ...
  $xam=trim(strip_tags($_POST['examtype'.$counter]));
  if($subval !=""){
    $newme = mysqli_query($conn, "INSERT INTO subby (studentid,examnum,subject,grade,examtype) VALUES ('$plicantid','$examnum','$subval','$graval','$xam')");
  }    
    $counter++;          
}   
                        
 //$newme = mysqli_query($conn, "INSERT INTO subgrade (oresultid,studentid,subject1,grading1,subject2,grading2,subject3,grading3,subject4,grading4,subject5,grading5,subject6,grading6,subject7,grading7,subject8,grading8,subject9,grading9) VALUES ('$oresultid','$plicantid', '$subject1','$grading1', '$subject2','$grading2','$subject3','$grading3','$subject4','$grading4','$subject5','$grading5', '$subject6','$grading6', '$subject7','$grading7', '$subject8','$grading8', '$subject9','$grading9')");

 //VALUES('$plicantid','$subject1','$grading1')");

  $reportalert="<script type ='text/javascript'>
                      alert('Subject successfully added, scroll down to view or edit');
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                 ...
                 <small><?php echo $plicantfulln;?>, please continue with the upload of your exam details .</small>

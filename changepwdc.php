...
if (isset($_POST['submit'])){
  ...
  $dopwd='kokoro'.$currentpwd;
   ...
   $hnewpwd=md5($dopwd2);
      //$hcnewpwd = md5($cnewpwd); 

  //    echo $currentpwd.''.$newpwd.''.$cnewpwd;

//if($currentpwd == "" ||  $newpwd == "" ||$cnewpwd == ""){
  //$reportalert="<script type ='text/javascript'>
 //alert('please do not submit an empty form.');
 // </script>";
  //} else{
$finda = mysqli_query($conn, "SELECT * FROM applicants WHERE emal='$plicantmail'");
...
while ($row=mysqli_fetch_assoc($finda)) {
  ...
  window.location.href='changepwdc.php';
  </script>";
      }
...
/*
  ...
  window.location.href='changepwdadmin.php';
  </script>";
      } */

else if (strlen($newpwd)>25||strlen($newpwd)<6) {
         $reportalert="<script type ='text/javascript'>
  ...
  window.location.href='changepwdc.php';
      ...
      /*  
      $bless = mysqli_query($conn, "SELECT * FROM adminlogin WHERE hash = '$hpwd' AND usemail = '$sesmail'");

      while ($row=mysqli_fetch_assoc($bless)){
      $pwd_db = $row['hash'];

    $rows = mysqli_num_rows($bless);
...
*/
      ...
      // if ($newpwd==$cnewpwd){
           ...
           if (mysqli_query($conn, "UPDATE applicants SET hpwd='$hnewpwd' WHERE emal='$plicantmail'")){
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>Change Password <?php echo $hpwd.' '.$hash_db; ?></h1>
                  <small></small>
               </div>
            </section>
            <!-- Main content -->

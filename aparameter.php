     ...
     $greg = "INSERT INTO app (psession,closingdate,applicationfee) VALUES ( '{$session}','{$cdate}','{$Appfee}')";
      if (mysqli_query($conn, $greg)) {
               $reportalert= "<script type ='text/javascript'>
                      alert('you have successfully uploaded an application fee');
                      window.location.href='aparameter.php';
                         </script>";
            }else{
...
$TOPE = mysqli_query($conn, "SELECT * FROM app");
                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" method = "post" action = "">
                              <div class="form-group">
                                 <label>session</label>
                                 <input type="text" name="session" class="form-control" placeholder="Enter session details" required>
                              </div>
                              <div class="form-group">
                                 <label>Closing date</label>
                                 <input type="date" name="cdate" class="form-control" placeholder="Enter closing date details" required>
                              </div>
                              <div class="form-group">
                                 <label>Application Fee</label>
                                 <input type="text" name="Appfee" class="form-control" placeholder="Enter Application fee details" required>
                              </div>

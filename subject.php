...
$query2 = mysqli_query($conn, "SELECT * FROM subject WHERE subjects='$subject'" );
...
echo $session_error = "<script type ='text/javascript'>
                      alert('this subject has already been saved');
 ...
 $new22 = "INSERT INTO subject (subjects) VALUES('$subject')";
...
if (mysqli_query($conn, $new22)) {
  $mes="<script type ='text/javascript'>
   ...
   $mes='<script type="text/javascript">
        alert("Subject unadded please retry.");
        </script>';
         $ms = "subject unadded please retry. ";
...
$sql = "DELETE FROM  0level WHERE id = $otherid";
 if($conn->query($sql) === true){ 
   $mes='<script type="text/javascript">
        alert("Subject deleted successfully.");
        </script>';
         $ms = "Subject deleted successfully. ";
} else{ 
   $mes='<script type="text/javascript">
        alert("Subject deletion  unsuccessful.");
        </script>';
         $ms = "Subject deletion unsuccessful.";
...
$bisola = mysqli_query($conn, "SELECT * FROM subject ORDER BY subjects ASC"); 
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>SUBJECT LIST</h1>
                  <small>Add and Delete subjects.</small>
               </div>
            </section>
            <!-- Main content -->
                           ...
                           <form method="post" action="">
                            <div class="form-group ">
                                <label>Add subject </label>
                                    <input type="text"  id="username" class="form-control" name="subject" >
                                  
                                </div>


                                
                                <input type= "submit"  name="reg" value="Submit subject"> <br>
                                <br>
</form>
...
<p><input type="submit" name="delete" value="delete subject"> </p>

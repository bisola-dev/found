...
<head>
        ...
        <title>Retrieve password: BOS Academy</title>
        ...
        <div class="lock-wrapper-page">
            ...
            <form method="post" action="login.php">
                ...
                <div class="form-group">
                    <h3>Bisola Omosola</h3>
                    <p class="text-muted">your password is OMOsolaB2019.</p>
                    <div class="input-group m-t-20">
                        
                       
                        <span class="input-group-btn"> 
                            <button type="submit" class="btn btn-add">click here to login</button> 
                        </span>
                    </div>
                </div>
                <div class="text-left">
                    <a href="login.php" class="text-muted">back to homepage</a>
                </div>
            </form>
        </div>
        <!-- /.content-wrapper -->

...
$queryx = mysqli_query($conn, "UPDATE  applicants SET statuz='Admitted' WHERE id='$candid'");
...
$queryy = mysqli_query($conn, "UPDATE  applicants SET statuz='Not Admitted' WHERE id='$candid'");
...
$bissy = mysqli_query($conn, "SELECT * FROM applicants");
                           ...
                           <div class="table-responsive">
                            ...
                            <div>
                                <button type ="submit" name="<?php echo $bname;?>" class="btn btn-<?php echo $bcolour;?>"><?php echo $button;?></button><br><br>
                                       ...
                                       <th><form method="post"  action="editapplicant.php">
                                       <input type="hidden" name="candid" value="<?php echo $id;?>">
                            
                                                      
                            <div>
                                <button type ="submit" name="submit" class="btn btn-primary">EDIT</button><br><br>

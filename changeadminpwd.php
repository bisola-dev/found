...
$finda = mysqli_query($conn, "SELECT * FROM adminlogin WHERE usmal='$sessmail'");
...
/*
  ...
  window.location.href='changepwdadmin.php';
         ...
         $reportalert="<script type ='text/javascript'>
  alert('Password must be betwwen 6 & 25 characters');
  window.location.href='changepwdadmin.php';
  </script>";
      }
...
*/
      ...
      // if ($newpwd==$cnewpwd){
           ...
           if (mysqli_query($conn, "UPDATE adminlogin SET hash='$hnewpwd' WHERE usmal='$sessmail'")){

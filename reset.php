                    ...
                    <div class="panel-heading">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                ...
                                <small><strong>Please fill in the required to reset your password.</strong></small>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <form method="post"  action="">
                            <div class="form-group">
                                ...
                                <input type="text" title="Please enter you email" required="" value="" name="npwd" class="form-control">
                                
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="username">Confirm Password</label>
                                <input type="text" title="Please enter you email" required="" value="" name="cpwd" class="form-control">
                            ...
                            <div class="form-group ">
                                 ...
                                 <select class="form-control" name="prog">
                                    ...
                                    <option>Favourite hangout</option>
                              ...
                              <div class="form-group">
                                <label class="control-label" for="username">Answer</label>
                                <input type="text" title="Please enter you email" required="" value="" name="ans" class="form-control">

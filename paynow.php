...
$Kingpaul = mysqli_query($conn, "SELECT * FROM app WHERE currentsession=1");
 while ($row=mysqli_fetch_assoc($Kingpaul)) {
      ...
      echo $plicantmail.''.$applicationfee2.''.$session2.''.$datereg;


if (isset($_POST['card'])){
  $appfee=trim(strip_tags($_POST['appfee']));
  $cardnum = trim(strip_tags($_POST['cardnum']));
   $cvv = trim(strip_tags($_POST['cvv']));
   $pin = trim(strip_tags($_POST['pin']));
   $edate= trim(strip_tags($_POST['edate']));
   
   echo $appfee.''.$cardnum.''.$cvv.''.$pin.''.$edate;
  
  if( $cardnum==""||$cvv==""||$pin=="" || $edate=="") {
  $reportalert="<script type ='text/javascript'>alert('please input  your card details.')</script>";}


  else if ((strlen ($cardnum)!=16) || (!(is_numeric ($cardnum))) ){
                 $reportalert='<script type="text/javascript">
        alert("please enter the correct 16 digits of your cardnumber.");
        </script>';
                 ...
                 $reportalert='<script type="text/javascript">
        alert("please enter the correct three digits behind your card.");
        </script>';

 }

else if ((strlen ($pin)!=4) || (!(is_numeric ($pin))) ){
                 $reportalert='<script type="text/javascript">
        alert("please enter the correct four digits of your pin.");
        </script>';

 }

else if ((strlen ($edate)!=4) || (!(is_numeric ($edate))) ){
                 $reportalert='<script type="text/javascript">
        alert("please enter the correct four digits of your expiry date.");
        </script>';
...
$newk = mysqli_query($conn, "INSERT INTO payment (name,email, amount, session,datepaid) 
        VALUES ('$plicantfulln','$plicantmail', '$applicationfee2', '$session2', '$datereg')"); 


//$flash = $newy.''.$newk;

//if (mysqli_query($conn, $flash)) {
  
$reportalert = '<script type="text/javascript">
        alert("Congratulations! Payment received.")
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <div class="header-title">
                  <h1>PAY HERE FOR <?php echo $session2;?> ACADEMIC SESSION.</h1>
                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading">
                           ...
                           <small> PAY HERE FOR <?php echo $session2;?> ACADEMIC SESSION.</small>
                           </div>
                        </div>
                           ...
                           <form class="col-sm-6" method= "post" action = "">
                            <div class="form-group">
                                <label>Application Fee </label>
                                 <input type="text" name="appfee" class="form-control" Value="<?php echo $applicationfee2;?>" disabled>
                              </div>


                              <div class="form-group">
                                <label>Enter Debit Card Number</label>
                                 <input type="text" name="cardnum" class="form-control" placeholder="Enter card number" required>
                              </div>
                              <div class="form-group">
                                 <label>CVV</label>
                                 <input type="text" name="cvv" class="form-control" placeholder="Enter cvv details" required>
                              </div>
                              <div class="form-group">
                                 <label>PIN</label>
                                 <input type="password" name="pin" class="form-control" placeholder="Enter pin details" required>
                              </div>

                              <div class="form-group">
                                 <label>EXPIRY DATE</label>
                                 <input type="text" name="edate" class="form-control" placeholder="Enter expiry card details" required>
                              </div>


                              <div>
                                <button type="submit" name="card" class="btn btn-success">PAY</button>                  
                             </div>

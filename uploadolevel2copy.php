...
echo $examtype.''.$examnum.' '.$examyear.''.$subject1.''.$grading1.''.$subject2.''.$grading2.''.$subject3.''.$grading3.''.$subject4.''.$grading4.''.$subject5.''.$grading5;
   ...
   if($subject1 == "" || $subject2 == "" ||$grading1 == "" ||$grading2 == "") {
 ...
 $new22 = "INSERT INTO waecresult (examtype,examnum, examyear, subject1, grading1, subject2, grading2, subject3,grading3,subject4,grading4,subject5,grading5,subject6,grading6, subject7,grading7,subject8,grading8,subject9,grading9) VALUES('$examtype','$examnum','$examyear','$subject1','$grading1','$subject2','$grading2','$subject3','$grading3','$subject4','$grading4','$subject5','$grading5','$subject6','$grading6','$subject7','$grading7','$subject8','$grading8','$subject9','$grading9')";
...
<?php 
                                    ...
                                    while ($row = mysqli_fetch_assoc($TOPE)) {$TOPE = mysqli_query($conn, "SELECT * FROM waecresult");pv
                                       $id = $row['id'];

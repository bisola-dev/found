...
if (isset($_POST['submit'])){
 ...
 //'.$subject2.''.$grading2.''.$subject3.''.$grading3.''.$subject4.''.$grading4.''.$subject5.''.$grading5;




   //if($examnum == "" || $examyear== "" ||$examtype == ""|| $subject1== "" || $grading1== ""||$subject2== "" || $grading2== ""||$subject3== "" || $grading3== ""||$subject4== "" || $grading4== ""||$subject5== "" || $grading5== ""){
...
//else {         
//echo $examtype.''.$examnum.' '.$examyear.''.$subject1.''.$grading1;

 $new22 = mysqli_query($conn, "INSERT INTO oresult (examtype,examnum, examyear, emal,datereg) VALUES('$examtype','$examnum','$examyear','$plicantmail','$dreg')");

   # code...             
                              
//$sub=$subject1.''.$subject2.''.$subject3.''.$subject4.''.$subject5.''.$subject6.''.$subject7.''.$subject8.''.$subject9;
$grad=$grading1.''.$grading2.''.$grading3.''.$grading4.''.$grading5.''.$grading6.''.$grading7.''.$grading8.''.$grading9;
                      $gracey =   1;
                  while ($gracey < 10 ){
                  $grading = $grading.''.$gracey;
                  $subject = $sub.$gracey;

                
                            
 $newme = mysqli_query($conn, "INSERT INTO subgrade (studentid,subjectz,gradez) VALUES ('$plicantid', '$sub','$grad')");
...
<?php 
                                     $count = 1;
                                     $TOPE = mysqli_query($conn, "SELECT * FROM oresult");
